    ...
    <article className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="p-4 space-y-3">
        ...
        <button
          ...
          className="w-full py-2.5 bg-black dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-200 disabled:opacity-50 text-white dark:text-black text-sm font-medium rounded-lg transition-colors"
        >
        ...
        {message && (
          <p className="text-xs text-center text-gray-600 dark:text-gray-400">{message}</p>
        )}
      </div>
    </article>
  );
