    ...
    <>
      ...
      <nav className="w-full h-25 bg-white border-b border-gray-200 shadow-lg px-6 flex items-center justify-between sticky top-0 z-30">
        ...
        <div className="flex items-center gap-7">
          <button onClick={() => setDrawerOpen(true)} className="p-2 rounded-full hover:bg-gray-100 transition-colors">
            <Menu size={30} className="text-gray-800" />
          </button>
          <Link href="/" className="cursor-pointer hover:opacity-80 transition-opacity">
            <span className="text-5xl font-bold tracking-tight text-black">Teckvora</span>
          </Link>
        </div>
        ...
        <div className="flex-1 max-w-xl mx-10">
          <div className="flex items-center w-full h-15 bg-gray-100 rounded-full px-4 border border-gray-200 focus-within:border-gray-400 focus-within:bg-white focus-within:ring-2 focus-within:ring-gray-200 transition-all">
            ...
            <input type="text" placeholder="Search products..." className="bg-transparent border-none outline-none text-lg w-full text-gray-800 placeholder:text-gray-400" />
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div onClick={() => setCartOpen(true)} className="flex flex-col items-center gap-0 cursor-pointer group">
