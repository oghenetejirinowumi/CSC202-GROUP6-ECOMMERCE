...
export default function RegisterPage() {
  ...
  const inputClass =
    "w-full px-4 py-3 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400";
  ...
  return (
    <main className="max-w-md mx-auto px-4 py-16">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-8">
        Join Teckvora to start shopping.
      </p>
